...
function PrenotaPadel(){
     ...
     .catch(error=>{
      ...
      //Slot orari
       useEffect(() => {
        ...
        fetch(`https://unable-kalie-mattiazerbini-d54da76b.koyeb.app/campi/${form.campoId}/orari?data=${form.data}&durata=${durataInMinuti}`, {
            headers: { 
    ...
    const handleSubmit = async (e) =>{
        ...
        try{
        const result = await fetch("https://unable-kalie-mattiazerbini-d54da76b.koyeb.app/prenotazioni", {
            method: "POST",
            headers: {
            ...
            const stripeResult = await fetch("https://unable-kalie-mattiazerbini-d54da76b.koyeb.app/pagamenti/checkout", {
                method: "POST",
                headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${token}`
