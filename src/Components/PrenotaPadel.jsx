...
function PrenotaPadel(){
    ...
    //Campi
    useEffect(() => {
     fetch("https://teenage-hynda-mattiazerbini-e6e83c07.koyeb.app/campi", { 
     ...
     fetch("https://teenage-hynda-mattiazerbini-e6e83c07.koyeb.app/servizi", {
      headers: {Authorization: `Bearer ${token}`}
    })
      .then(response=> {
     ...
     .catch(error=>{
      ...
      //Slot orari
       useEffect(() => {
        ...
        fetch(`https://teenage-hynda-mattiazerbini-e6e83c07.koyeb.app/campi/${form.campoId}/orari?data=${form.data}&durata=${durataInMinuti}`, {
            headers: { 
    ...
    const handleSubmit = async (e) =>{
        ...
        try{
        const result = await fetch("https://teenage-hynda-mattiazerbini-e6e83c07.koyeb.app/prenotazioni", {
            method: "POST",
            headers: {
            ...
            const stripeResult = await fetch("https://teenage-hynda-mattiazerbini-e6e83c07.koyeb.app/pagamenti/checkout", {
                method: "POST",
                headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${token}`
