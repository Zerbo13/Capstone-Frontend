...
function Register(){
    ...
    const handleSubmit = async (e) =>{
        ...
        setError("");
        try{
        const result = await fetch("https://unable-kalie-mattiazerbini-d54da76b.koyeb.app/auth/register", {
            method: "POST",
    ...
    if(avatar && utente.id){
        const login = await fetch("https://unable-kalie-mattiazerbini-d54da76b.koyeb.app/auth/login", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      ...
      if(token){
        ...
        await fetch(`https://unable-kalie-mattiazerbini-d54da76b.koyeb.app/utenti/${utente.id}/avatar`, {
            method: "PATCH",
