...
const headers = { Authorization: `Bearer ${token}` };
    ...
    Promise.all([
      fetch("https://unable-kalie-mattiazerbini-d54da76b.koyeb.app/prenotazioni", {headers}).then(res => res.json()),
      fetch("https://unable-kalie-mattiazerbini-d54da76b.koyeb.app/utenti", {headers}).then(res => res.json()),
      fetch("https://unable-kalie-mattiazerbini-d54da76b.koyeb.app/campi", {headers}).then(res => res.json()),
      fetch("https://unable-kalie-mattiazerbini-d54da76b.koyeb.app/servizi", {headers}).then(res => res.json()),
