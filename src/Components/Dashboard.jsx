...
const headers = { Authorization: `Bearer ${token}` };
    ...
    Promise.all([
      fetch("https://teenage-hynda-mattiazerbini-e6e83c07.koyeb.app/prenotazioni", {headers}).then(res => res.json()),
      fetch("https://teenage-hynda-mattiazerbini-e6e83c07.koyeb.app/utenti", {headers}).then(res => res.json()),
      fetch("https://teenage-hynda-mattiazerbini-e6e83c07.koyeb.app/campi", {headers}).then(res => res.json()),
      fetch("https://teenage-hynda-mattiazerbini-e6e83c07.koyeb.app/servizi", {headers}).then(res => res.json()),
