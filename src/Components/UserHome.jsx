...
function UserHome(){
    return(
               <div className="container mt-5 text-center">
                ...
                <div className="mb-4"><video src="/public/video/VideoPadel.mp4" className="w-100" autoPlay loop muted playsInline style={{borderRadius: "10px", maxHeight: "550px", objectFit:"cover"}}/>
      </div>
